Đây là template mẫu cho chế độ uart :>>
File top của bạn có thể tên là gì cũng được, nhưng module bên trong phải là top_module.
Ở chế độ này bạn dùng được toàn bộ ngoại vi cơ bản, thêm uart terminal.
...
"docker run --rm -v "$(pwd):/src" huyatieo/fpga-compiler -DMODE_UART"